...
Este projeto apresenta uma análise detalhada dos acidentes em rodovias federais brasileiras, com foco em segurança viária, perfil das vítimas e principais fatores causadores. O trabalho envolve o tratamento de bases públicas, modelagem de dados, criação de métricas em DAX e o desenvolvimento de um dashboard interativo no Power BI com temática Dark Mode.
...
Qual a evolução mensal do volume de acidentes e como ela se compara ao ano anterior?

Quais são as 10 principais causas que geram sinistros nas rodovias?

Quais estados (UFs) apresentam o maior número de fatalidades?

Qual o percentual de letalidade dos acidentes no período analisado?

Qual o perfil de gênero predominante entre as vítimas e envolvidos?
...
O dashboard apresenta os seguintes indicadores centrais:
...
docs/: Documentação e imagens do dashboard.
